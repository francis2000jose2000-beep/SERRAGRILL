  ...
  return (
    <footer className="bg-slate-950 border-t border-slate-800 text-slate-400 py-10 px-6 text-sm">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <h3 className="text-amber-500 font-bold mb-2">Serra&amp;Grill</h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-zinc-400 text-sm">
            ...
            <li className="text-amber-500/80">Domingo: Fechado</li>
          </ul>
        </div>
        <div>
          ...
          <div className="space-y-3 text-sm text-[#EAE6DF]">
            <div className="flex items-center gap-2">
              <a href="tel:+351932697927" className="hover:text-[#C5A059] transition-colors duration-300">
                +351 932697927
              </a>
            </div>
            <div className="flex items-center gap-2">
              <a href="mailto:geral@domgroup.pt" className="hover:text-[#C5A059] transition-colors duration-300">
                geral@domgroup.pt
              </a>
            </div>
          </div>
